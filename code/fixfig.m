...
%     axes(i); % specify the subplot
    ...
    set(i,'FontSize',fontsizefact*sc,'FontWeight','bold','FontName',myfont)

    % title
    set(get(i,'Title'),'FontSize',fontsizefact*sc,'FontWeight','bold','FontName',myfont)

    % x axis label
    set(get(i,'XLabel'),'FontSize',fontsizefact*sc,'FontWeight','bold','FontName',myfont)

    % y axis label
    set(get(i,'YLabel'),'FontSize',fontsizefact*sc,'FontWeight','bold','FontName',myfont)
