...
%     '../dataformodel/pca_med_gcs/*.mat',...
%     '../dataformodel/PCA_w_late/*.mat'};
>>>>>>> beginning of maximum likelihood estimation of firing rate as a function of voltage
...
%% fit each plasticity trace with least squares
figure;
...
% make the matrix X such that DeltaV = X * F
X = [];
for i=1:length(plasticity_files)
